...
function tmopso(seed, func_name)
%% Problem Definition
...
% % zdt1 feasible
% target_region.lb = [0.6 0.6];
% target_region.ub = [0.9 0.9];

% % zdt1 infeasible
% target_region.lb = [0 0];
% target_region.ub = [0.3 0.3];

% zdt1 intersect
target_region.lb = [0.3 0.3];
target_region.ub = [0.4 0.4];


% target_region.lb = [0.2 0.8];
% target_region.ub = [0.4 1];
